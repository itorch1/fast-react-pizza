...
function Button({ children, disabled, to, type, onClick }) {
  ...
  const styles = {
    ...
    secondary:
      "inline-block text-sm rounded-full font-semibold uppercase tracking-wide border-2 border-stone-400 text-stone-400 transition-colors duration-300 hover:bg-stone-400 hover:text-stone-100 focus:bg-stone-400 focus:text-stone-100 focus:outline-none focus:ring focus:ring-stone-400 focus:ring-offset-2 disabled:cursor-not-allowed px-4 py-2.5 md:px-6 md:py-3.5",
    round: base + " px-2.5 py-1 md:px-3.5 md:py-2 text-xsm",
  };
